    ...
    return (
        ...
        >
            ...
            <div className="about__blockParagraphe">
                ...
                <p className="paragraphe">Notre équipe est composée de développeurs expérimentés et passionnés, capables de créer des sites et des applications mobiles sur Android et IOS. Nous sommes également agréés au chèque numérique de la Région, ce qui permet à nos clients de se faire rembourser jusqu'à 80% des sommes déboursées pour leur site ou application mobile.</p>
